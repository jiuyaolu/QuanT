...
A detailed vignette can be accessed via https://jiuyaolu.github.io/QuanT/QuanT.html.

It introduces the CRC dataset and explains how to analyze the CRC dataset using QuanT. It also compares SVA and RUV with QuanT.
